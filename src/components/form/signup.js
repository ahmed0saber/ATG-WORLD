    ...
    return (
        ...
        <Container className="rounded" Style="margin-top:30px;max-width:800px;background:white;padding:0;position:relative;">
            ...
            <Row className="p-3">
                    ...
                    <Form>
                        <div Style="display:flex;">
                            <Form.Group className="w-50">
                                <Form.Control Style="border-radius:0px;height:46px;background:#F7F8FA;" type="text" placeholder="First Name" />
                            </Form.Group>
                            <Form.Group className="w-50">
                                <Form.Control Style="border-radius:0px;height:46px;background:#F7F8FA;" type="text" placeholder="Last Name" />
                            </Form.Group>
                        </div>
                        <Form.Group>
                        ...
                        <Form.Group>
                            <Form.Control Style="border-radius:0px;height:46px;background:#F7F8FA;" type="password" placeholder="Confirm Password" />
                        </Form.Group>
                ...
                <Col sm="6">
                <Nav>
                    <NavLink className="m-auto" to="/login">
                        Already have an account? <span Style="color: #2F6CE5; font-weight:bold;">Sign In</span>
                    </NavLink>
                </Nav>
                <img src={image} alt="join us"/>
                <Nav>
                    <Nav.Link className="m-auto" href="#">
